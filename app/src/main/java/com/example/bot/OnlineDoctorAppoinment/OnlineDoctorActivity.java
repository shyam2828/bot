package com.example.bot.OnlineDoctorAppoinment;
...
import com.example.bot.MainActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(OnlineDoctorActivity.this, MainActivity.class));
            }
        });
        ...
        appoinment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(txt_patient) || TextUtils.isEmpty(txt_email) || TextUtils.isEmpty(txt_age)  || TextUtils.isEmpty(txt_dob)  || TextUtils.isEmpty(txt_symptom)  || TextUtils.isEmpty(txt_gender)  || TextUtils.isEmpty(txt_mobile)  || TextUtils.isEmpty(txt_address)) {
                    Toast.makeText(OnlineDoctorActivity.this, "All fileds are required", Toast.LENGTH_SHORT).show();
                }
                else if (txt_address.length() < 20 ) {
                    Toast.makeText(OnlineDoctorActivity.this, "address must be at least 20 characters", Toast.LENGTH_SHORT).show();
                }
                else
                {
